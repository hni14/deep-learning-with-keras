...
パーセプトロンとは、活性化関数としてステップ関数を用いるニューラルネットワークの呼称です。  
また、パーセプトロンの層の数に応じて、単層パーセプトロン、多層パーセプトロンと呼ばれます。  

ニューラルネットワークとパーセプトロンの違いは、活性化関数のみです。  
...
|ADD|線形関数|1|-|ニューラルネットワーク|
|MINUS|線形関数|1|-|ニューラルネットワーク|
